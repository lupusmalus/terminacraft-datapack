...
execute in termina positioned -779 57 -276 if entity @p[distance=..3] run tag @p add trCTGuardE
execute in termina positioned -779 57 -276 unless entity @p[distance=..3] run tag @p remove trCTGuardE

execute as @e[tag=trCTGuardE] at @s if block ~-1 ~ ~ minecraft:air run tp @e[scores={CTGuardE=0..}, limit=1, sort=nearest] -779 57 ~ -90 0
execute as @e[tag=trCTGuardE] at @s if block ~-1 ~ ~ minecraft:barrier run tp @e[scores={CTGuardE=0..}, limit=1, sort=nearest] -779 57 ~ -90 0
execute as @e[tag=trCTGuardE] at @s if block ~-1 ~ ~ #mm:invisible run tp @e[scores={CTGuardE=0..}, limit=1, sort=nearest] -779 57 ~ -90 0
