...
execute if entity @s[scores={Mask=0}] run playsound mm.ocarina.u master @a ~ ~ ~ 1 1
execute if entity @s[scores={Deku=1}] run playsound mm.pipe.u master @a ~ ~ ~ 1 1
execute if entity @s[scores={Goron=1}] run playsound mm.drums.u master @a ~ ~ ~ 1 1
