...
execute unless score @s Item_Cleared matches 1.. unless entity @s[nbt={Inventory:[{Slot:2b}]}] run item replace entity @s hotbar.2 with carrot_on_a_stick{display:{Name:'{"text":"Goron Mask","color":"white","italic":false}',Lore:['{"text":"Wear it to assume Goron form.","color":"white","italic":false}','{"text":"Take it off to change back.","color":"white","italic":false}']},HideFlags:63,Unbreakable:1b,cbutton:1b,goronmask:1b,CustomModelData:9000011} 1
execute store result score @s Item_Cleared run clear @s carrot_on_a_stick{CustomModelData:9000011} 0
...
execute unless score @s Item_Cleared matches 1.. unless entity @s[nbt={Inventory:[{Slot:3b}]}] run item replace entity @s hotbar.3 with carrot_on_a_stick{display:{Name:'{"text":"Goron Mask","color":"white","italic":false}',Lore:['{"text":"Wear it to assume Goron form.","color":"white","italic":false}','{"text":"Take it off to change back.","color":"white","italic":false}']},HideFlags:63,Unbreakable:1b,cbutton:1b,goronmask:1b,CustomModelData:9000011} 1
execute store result score @s Item_Cleared run clear @s carrot_on_a_stick{CustomModelData:9000011} 0
...
execute unless score @s Item_Cleared matches 1.. unless entity @s[nbt={Inventory:[{Slot:4b}]}] run item replace entity @s hotbar.4 with carrot_on_a_stick{display:{Name:'{"text":"Goron Mask","color":"white","italic":false}',Lore:['{"text":"Wear it to assume Goron form.","color":"white","italic":false}','{"text":"Take it off to change back.","color":"white","italic":false}']},HideFlags:63,Unbreakable:1b,cbutton:1b,goronmask:1b,CustomModelData:9000011} 1
execute store result score @s Item_Cleared run clear @s carrot_on_a_stick{CustomModelData:9000011} 0
...
execute unless score @s Item_Cleared matches 1.. unless entity @s[nbt={Inventory:[{Slot:5b}]}] run item replace entity @s hotbar.5 with carrot_on_a_stick{display:{Name:'{"text":"Goron Mask","color":"white","italic":false}',Lore:['{"text":"Wear it to assume Goron form.","color":"white","italic":false}','{"text":"Take it off to change back.","color":"white","italic":false}']},HideFlags:63,Unbreakable:1b,cbutton:1b,goronmask:1b,CustomModelData:9000011} 1
execute store result score @s Item_Cleared run clear @s carrot_on_a_stick{CustomModelData:9000011} 0
...
execute unless score @s Item_Cleared matches 1.. unless entity @s[nbt={Inventory:[{Slot:6b}]}] run item replace entity @s hotbar.6 with carrot_on_a_stick{display:{Name:'{"text":"Goron Mask","color":"white","italic":false}',Lore:['{"text":"Wear it to assume Goron form.","color":"white","italic":false}','{"text":"Take it off to change back.","color":"white","italic":false}']},HideFlags:63,Unbreakable:1b,cbutton:1b,goronmask:1b,CustomModelData:9000011} 1
execute store result score @s Item_Cleared run clear @s carrot_on_a_stick{CustomModelData:9000011} 0
...
execute unless score @s Item_Cleared matches 1.. run item replace entity @s hotbar.7 with carrot_on_a_stick{display:{Name:'{"text":"Goron Mask","color":"white","italic":false}',Lore:['{"text":"Wear it to assume Goron form.","color":"white","italic":false}','{"text":"Take it off to change back.","color":"white","italic":false}']},HideFlags:63,Unbreakable:1b,cbutton:1b,goronmask:1b,CustomModelData:9000011} 1
