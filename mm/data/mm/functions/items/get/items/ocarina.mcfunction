...
execute unless score @s Item_Cleared matches 1.. unless entity @s[nbt={Inventory:[{Slot:4b}]}] run replaceitem entity @s hotbar.4 carrot_on_a_stick{display:{Name:'{"text":"Ocarina of Time","color":"white","italic":false}',Lore:['{"text":"This musical instrument is filled","color":"white","italic":false}','{"text":"with memories of Princess Zelda.","color":"white","italic":false}']},HideFlags:63,Unbreakable:1b,cbutton:1b,ocarina:1b,CustomModelData:8000000} 1
execute store result score @s Item_Cleared run clear @s carrot_on_a_stick{CustomModelData:8000000} 0
...
execute unless score @s Item_Cleared matches 1.. unless entity @s[nbt={Inventory:[{Slot:5b}]}] run replaceitem entity @s hotbar.5 carrot_on_a_stick{display:{Name:'{"text":"Ocarina of Time","color":"white","italic":false}',Lore:['{"text":"This musical instrument is filled","color":"white","italic":false}','{"text":"with memories of Princess Zelda.","color":"white","italic":false}']},HideFlags:63,Unbreakable:1b,cbutton:1b,ocarina:1b,CustomModelData:8000000} 1
execute store result score @s Item_Cleared run clear @s carrot_on_a_stick{CustomModelData:8000000} 0
...
execute unless score @s Item_Cleared matches 1.. unless entity @s[nbt={Inventory:[{Slot:6b}]}] run replaceitem entity @s hotbar.6 carrot_on_a_stick{display:{Name:'{"text":"Ocarina of Time","color":"white","italic":false}',Lore:['{"text":"This musical instrument is filled","color":"white","italic":false}','{"text":"with memories of Princess Zelda.","color":"white","italic":false}']},HideFlags:63,Unbreakable:1b,cbutton:1b,ocarina:1b,CustomModelData:8000000} 1
execute store result score @s Item_Cleared run clear @s carrot_on_a_stick{CustomModelData:8000000} 0
...
execute unless score @s Item_Cleared matches 1.. run replaceitem entity @s hotbar.7 carrot_on_a_stick{display:{Name:'{"text":"Ocarina of Time","color":"white","italic":false}',Lore:['{"text":"This musical instrument is filled","color":"white","italic":false}','{"text":"with memories of Princess Zelda.","color":"white","italic":false}']},HideFlags:63,Unbreakable:1b,cbutton:1b,ocarina:1b,CustomModelData:8000000} 1
