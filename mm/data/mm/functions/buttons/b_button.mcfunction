...
execute as @a[scores={Deku=1,Magic=1..},tag=!debug,tag=!deku_flying] unless entity @s[scores={Deku_Flying=0..}, nbt={Inventory:[{Slot:0b,tag:{bbutton:1b,shoot:1b}}]}] run replaceitem entity @s hotbar.0 carrot_on_a_stick{display:{Name:'{"text":"Shoot","color":"white","italic":false}'},CustomModelData:1000000,bbutton:1b,shoot:1b}
execute as @a[scores={Deku=1, Magic=0},tag=!debug,tag=!deku_flying] unless entity @s[nbt={Inventory:[{Slot:0b,tag:{bbutton:1b,shoot_none:1b}}]}] run replaceitem entity @s hotbar.0 iron_nugget{display:{Name:'{"text":"Shoot","color":"white","italic":false}'},CustomModelData:1000000,bbutton:1b,shoot_none:1b}
execute as @a[scores={Deku=1},tag=!debug,tag=deku_flying] unless entity @s[nbt={Inventory:[{Slot:0b,tag:{bbutton:1b,dropnut:1b}}]}] run replaceitem entity @s hotbar.0 carrot_on_a_stick{display:{Name:'{"text":"Deku Nut","color":"white","italic":false}'},CustomModelData:8000008,bbutton:1b,dropnut:1b}
...
execute as @a[scores={Deku=1},tag=!debug] unless score @s Magic matches 0.. if entity @s[nbt={Inventory:[{Slot:0b}]}] run replaceitem entity @s hotbar.0 air
