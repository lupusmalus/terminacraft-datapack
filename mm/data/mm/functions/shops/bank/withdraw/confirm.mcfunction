...
execute unless score #Global Bank_Trans matches 0 as @a run tellraw @s [{"text":"Are you really withdrawing ","color":"white"},{"score":{"name":"#Global","objective":"Bank_Trans"},"color":"#FFC0CB"},{"text":" Rupee(s)","color":"#FFC0CB"},{"text":"?\n\n"},{"text":"Yes\n","color":"green","clickEvent":{"action":"run_command","value":"/function mm:shops/bank/withdraw/transaction"}},{"text":"No","color":"green","clickEvent":{"action":"run_command","value":"/function mm:shops/bank/select"}}]
